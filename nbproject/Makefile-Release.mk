...
${OBJECTDIR}/src/CPIDRegler.o: src/CPIDRegler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CPIDRegler.o src/CPIDRegler.cpp
...
${OBJECTDIR}/src/CKalmanFilter.o: src/CKalmanFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CKalmanFilter.o src/CKalmanFilter.cpp
