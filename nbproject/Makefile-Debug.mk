...
${OBJECTDIR}/src/RPMeter.o: src/RPMeter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/RPMeter.o src/RPMeter.cpp

${OBJECTDIR}/src/PWMDriver.o: src/PWMDriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/PWMDriver.o src/PWMDriver.cpp
